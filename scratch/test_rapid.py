...
req1 = urllib.request.Request(url1, headers={"x-rapidapi-key": rapid_key, "x-rapidapi-host": "sky-scrapper.p.rapidapi.com"})
try:
...
req2 = urllib.request.Request(url2, headers={"x-rapidapi-key": rapid_key, "x-rapidapi-host": "indian-railway-irctc.p.rapidapi.com"})
try:
